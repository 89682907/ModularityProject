...
-keepclassmembers class * {
    @com.modularity.signature.annotation.KeepNotProguard <methods>;
}

-keep @com.modularity.signature.annotation.KeepNotProguard class * {*;}
-keep class * {
    @com.modularity.signature.annotation.KeepNotProguard <fields>;
}
-keepclassmembers class * {
    @com.modularity.signature.annotation.KeepNotProguard <methods>;
}
