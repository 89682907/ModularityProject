...
-keepclassmembers class * {
    @com.modularity.lib.crosswalk.annotation.KeepNotProguard <methods>;
}

-keep @com.modularity.lib.crosswalk.annotation.KeepNotProguard class * {*;}
-keep class * {
    @com.modularity.lib.crosswalk.annotation.KeepNotProguard <fields>;
}
-keepclassmembers class * {
    @com.modularity.lib.crosswalk.annotation.KeepNotProguard <methods>;
}
