...
public final class ResourceManager {
    ...
    public static Drawable getDrawable(@DrawableRes int id) {
        return ContextCompat.getDrawable(Managers.getApp(), id);
    }
    ...
    public static int getIdByName(String name) {
        return Managers.getApp().getResources().getIdentifier(name, "id", Managers.getApp().getPackageName());
    }
    ...
    public static int getStringIdByName(String name) {
        return Managers.getApp().getResources().getIdentifier(name, "string", Managers.getApp().getPackageName());
    }
    ...
    public static int getColorIdByName(String name) {
        return Managers.getApp().getResources().getIdentifier(name, "color", Managers.getApp().getPackageName());
    }
    ...
    public static int getDimenIdByName(String name) {
        return Managers.getApp().getResources().getIdentifier(name, "dimen", Managers.getApp().getPackageName());
    }
    ...
    public static int getDrawableIdByName(String name) {
        return Managers.getApp().getResources().getIdentifier(name, "drawable", Managers.getApp().getPackageName());
    }
    ...
    public static int getMipmapIdByName(String name) {
        return Managers.getApp().getResources().getIdentifier(name, "mipmap", Managers.getApp().getPackageName());
    }
    ...
    public static int getLayoutIdByName(String name) {
        return Managers.getApp().getResources().getIdentifier(name, "layout", Managers.getApp().getPackageName());
    }
    ...
    public static int getStyleIdByName(String name) {
        return Managers.getApp().getResources().getIdentifier(name, "style", Managers.getApp().getPackageName());
    }
    ...
    public static int getAnimIdByName(String name) {
        return Managers.getApp().getResources().getIdentifier(name, "anim", Managers.getApp().getPackageName());
    }
    ...
    public static int getMenuIdByName(String name) {
        return Managers.getApp().getResources().getIdentifier(name, "menu", Managers.getApp().getPackageName());
    }
    ...
    public static boolean copyFileFromAssets(final String assetsFilePath, final String destFilePath) {
        boolean res = true;
        try {
            String[] assets = Managers.getApp().getAssets().list(assetsFilePath);
            if (assets != null && assets.length > 0) {
                for (String asset : assets) {
                    res &= copyFileFromAssets(assetsFilePath + "/" + asset, destFilePath + "/" + asset);
                }
            } else {
                res = ManagerBridge.writeFileFromIS(
                        destFilePath,
                        Managers.getApp().getAssets().open(assetsFilePath)
                );
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static String readAssets2String(final String assetsFilePath, final String charsetName) {
        try {
            InputStream is = Managers.getApp().getAssets().open(assetsFilePath);
            byte[] bytes = ManagerBridge.inputStream2Bytes(is);
    ...
    public static List<String> readAssets2List(final String assetsPath,
        ...
        try {
            return ManagerBridge.inputStream2Lines(Managers.getApp().getResources().getAssets().open(assetsPath), charsetName);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static boolean copyFileFromRaw(@RawRes final int resId, final String destFilePath) {
        return ManagerBridge.writeFileFromIS(
                destFilePath,
                Managers.getApp().getResources().openRawResource(resId)
        );
    }
    ...
    public static String readRaw2String(@RawRes final int resId, final String charsetName) {
        InputStream is = Managers.getApp().getResources().openRawResource(resId);
        byte[] bytes = ManagerBridge.inputStream2Bytes(is);
    ...
    public static List<String> readRaw2List(@RawRes final int resId,
                                            final String charsetName) {
        return ManagerBridge.inputStream2Lines(Managers.getApp().getResources().openRawResource(resId), charsetName);
    }
}
