...
public final class Managers {
    ...
    public static void init(final Application app) {
        ...
        if (sApp == null) {
            sApp = app;
            ManagerBridge.init(sApp);
            ManagerBridge.preLoad();
            return;
        }
        if (sApp.equals(app)) return;
        ManagerBridge.unInit(sApp);
        sApp = app;
        ManagerBridge.init(sApp);
    }
    ...
    public static Application getApp() {
        ...
        init(ManagerBridge.getApplicationByReflect());
        if (sApp == null) throw new NullPointerException("reflect failed.");
        Log.i("Utils", ManagerBridge.getCurrentProcessName() + " reflect app success.");
        return sApp;
    }
    ...
    public abstract static class Task<Result> extends ThreadManager.SimpleTask<Result> {
