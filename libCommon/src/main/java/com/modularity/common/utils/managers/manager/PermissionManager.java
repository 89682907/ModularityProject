...
import com.modularity.common.utils.managers.constant.PermissionConstants;
...
public final class PermissionManager {
    ...
    public static List<String> getPermissions() {
        return getPermissions(Managers.getApp().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(Managers.getApp(), permission);
    }
    ...
    public static boolean isGrantedWriteSettings() {
        return Settings.System.canWrite(Managers.getApp());
    }
    ...
    private static void startWriteSettingsActivity(final Activity activity, final int requestCode) {
        ...
        intent.setData(Uri.parse("package:" + Managers.getApp().getPackageName()));
        if (!ManagerBridge.isIntentAvailable(intent)) {
    ...
    public static boolean isGrantedDrawOverlays() {
        return Settings.canDrawOverlays(Managers.getApp());
    }
    ...
    public static void launchAppDetailsSettings() {
        Intent intent = ManagerBridge.getLaunchAppDetailsSettingsIntent(Managers.getApp().getPackageName(), true);
     ...
     *
     * @param permissions The permissions.
     * @return the single {@link PermissionManager} instance
     */
    public static PermissionManager permission(@PermissionConstants.Permission final String... permissions) {
        return new PermissionManager(permissions);
    }

    private PermissionManager(final String... permissions) {
     ...
     * @return the single {@link PermissionManager} instance
     */
    public PermissionManager callback(final SingleCallback callback) {
     ...
     * @return the single {@link PermissionManager} instance
     */
    public PermissionManager callback(final SimpleCallback callback) {
     ...
     * @return the single {@link PermissionManager} instance
     */
    public PermissionManager callback(final FullCallback callback) {
     ...
     * @return the single {@link PermissionManager} instance
     */
    public PermissionManager theme(final ThemeCallback callback) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    private boolean shouldRationale(final ManagerTransActivity activity, final Runnable againRunnable) {
    ...
    private void rationalInner(final ManagerTransActivity activity, final Runnable againRunnable) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    static final class PermissionActivityImpl extends ManagerTransActivity.TransActivityDelegate {
        ...
        public static void start(final int type) {
            ManagerTransActivity.start(new Managers.Consumer<Intent>() {
                @Override
        ...
        @Override
        public void onCreated(final ManagerTransActivity activity, @Nullable Bundle savedInstanceState) {
        ...
        @Override
        public void onRequestPermissionsResult(ManagerTransActivity activity,
                                               int requestCode,
                                               String[] permissions,
                                               int[] grantResults) {
            activity.finish();
        ...
        @Override
        public boolean dispatchTouchEvent(ManagerTransActivity activity, MotionEvent ev) {
            activity.finish();
            return true;
        }

        @Override
        public void onDestroy(final ManagerTransActivity activity) {
        ...
        @Override
        public void onActivityResult(ManagerTransActivity activity, int requestCode, int resultCode, Intent data) {
            activity.finish();
        }
    ...
    public interface OnRationaleListener {
        ...
        void rationale(ManagerTransActivity activity, ShouldRequest shouldRequest);
