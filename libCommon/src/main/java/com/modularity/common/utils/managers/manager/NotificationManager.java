...
public class NotificationManager {
    ...
    public static boolean areNotificationsEnabled() {
        return NotificationManagerCompat.from(Managers.getApp()).areNotificationsEnabled();
    }
     ...
     */
    public static void notify(int id, Managers.Consumer<NotificationCompat.Builder> consumer) {
     ...
     * @param consumer The consumer of create the builder of notification.
     */
    public static void notify(String tag, int id, Managers.Consumer<NotificationCompat.Builder> consumer) {
     ...
     * @param consumer      The consumer of create the builder of notification.
     */
    public static void notify(int id, ChannelConfig channelConfig, Managers.Consumer<NotificationCompat.Builder> consumer) {
     ...
     * @param consumer      The consumer of create the builder of notification.
     */
    public static void notify(String tag, int id, ChannelConfig channelConfig, Managers.Consumer<NotificationCompat.Builder> consumer) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            android.app.NotificationManager nm = (android.app.NotificationManager) Managers.getApp().getSystemService(Context.NOTIFICATION_SERVICE);
            //noinspection ConstantConditions
            nm.createNotificationChannel(channelConfig.getNotificationChannel());
        }

        NotificationManagerCompat nmc = NotificationManagerCompat.from(Managers.getApp());

        NotificationCompat.Builder builder = new NotificationCompat.Builder(Managers.getApp());
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    public static void cancel(String tag, final int id) {
        NotificationManagerCompat.from(Managers.getApp()).cancel(tag, id);
    }
    ...
    public static void cancel(final int id) {
        NotificationManagerCompat.from(Managers.getApp()).cancel(id);
    }
    ...
    public static void cancelAll() {
        NotificationManagerCompat.from(Managers.getApp()).cancelAll();
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = Managers.getApp().getSystemService("statusbar");
    ...
    public static void openNoticeSetting() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            intent.putExtra("android.provider.extra.APP_PACKAGE", Managers.getApp().getPackageName());
        } else if (Build.VERSION.SDK_INT >= 21) {
            // android 5.0-7.0
            intent.setAction("android.settings.APP_NOTIFICATION_SETTINGS");
            intent.putExtra("app_package", Managers.getApp().getPackageName());
            intent.putExtra("app_uid", Managers.getApp().getApplicationInfo().uid);
        } else {
            // 其他
            intent.setAction("android.settings.APPLICATION_DETAILS_SETTINGS");
            intent.setData(Uri.fromParts("package", Managers.getApp().getPackageName(), null));
        }
    ...
    public static class ChannelConfig {
        ...
        public static final ChannelConfig DEFAULT_CHANNEL_CONFIG = new ChannelConfig(
                Managers.getApp().getPackageName(), Managers.getApp().getPackageName(), IMPORTANCE_DEFAULT
        );
         ...
         * {@link android.app.NotificationManager#createNotificationChannel(NotificationChannel)}, unless the
         * channel is not currently part of a group.
         *
         * @param groupId the id of a group created by
         *                {@link android.app.NotificationManager#createNotificationChannelGroup)}.
         */
         ...
         * <p>
         * Only modifiable before the channel is submitted to
         * {@link android.app.NotificationManager#createNotificationChannel(NotificationChannel)}.
         *
         ...
         * least {@link android.app.NotificationManager#IMPORTANCE_DEFAULT} should have a sound.
         * <p>
         * Only modifiable before the channel is submitted to
         * {@link android.app.NotificationManager#createNotificationChannel(NotificationChannel)}.
         */
