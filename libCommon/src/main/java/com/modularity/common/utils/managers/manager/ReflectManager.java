...
public final class ReflectManager {

    private final Class<?> type;

    private final Object object;

    private ReflectManager(final Class<?> type) {
        this(type, type);
    }

    private ReflectManager(final Class<?> type, Object object) {
        this.type = type;
        this.object = object;
    }
     ...
     */
    public static ReflectManager reflect(final String className)
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static ReflectManager reflect(final String className, final ClassLoader classLoader)
            throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static ReflectManager reflect(final Class<?> clazz)
            throws ReflectException {
        return new ReflectManager(clazz);
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static ReflectManager reflect(final Object object)
            throws ReflectException {
        return new ReflectManager(object == null ? Object.class : object.getClass(), object);
    }
     ...
     * @return the single {@link ReflectManager} instance
     */
    public ReflectManager newInstance() {
     ...
     * @return the single {@link ReflectManager} instance
     */
    public ReflectManager newInstance(Object... args) {
    ...
    private ReflectManager newInstance(final Constructor<?> constructor, final Object... args) {
        try {
     ...
     * @return the single {@link ReflectManager} instance
     */
    public ReflectManager field(final String name) {
        try {
            Field field = getField(name);
            return new ReflectManager(field.getType(), field.get(object));
     ...
     * @return the single {@link ReflectManager} instance
     */
    public ReflectManager field(String name, Object value) {
        try {
            Field field = getField(name);
    ...
    private Object unwrap(Object object) {
        if (object instanceof ReflectManager) {
            return ((ReflectManager) object).get();
        }
        return object;
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public ReflectManager method(final String name) throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public ReflectManager method(final String name, final Object... args) throws ReflectException {
        Class<?>[] types = getArgsType(args);
        try {
    ...
    private ReflectManager method(final Method method, final Object obj, final Object... args) {
        try {
            accessible(method);
    ...
    public boolean equals(Object obj) {
        return obj instanceof ReflectManager && object.equals(((ReflectManager) obj).get());
    }
