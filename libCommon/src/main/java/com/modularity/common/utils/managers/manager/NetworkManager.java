...
public final class NetworkManager {
    ...
    public static Managers.Task<Boolean> isAvailableAsync(@NonNull final Managers.Consumer<Boolean> consumer) {
        return ManagerBridge.doAsync(new Managers.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(INTERNET)
    public static void isAvailableByPingAsync(final Managers.Consumer<Boolean> consumer) {
     ...
     */
    @RequiresPermission(INTERNET)
    public static Managers.Task<Boolean> isAvailableByPingAsync(final String ip, @NonNull final Managers.Consumer<Boolean> consumer) {
        return ManagerBridge.doAsync(new Managers.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
            public Boolean doInBackground() {
    ...
    public static boolean isAvailableByPing(final String ip) {
        ...
        ShellManager.CommandResult result = ShellManager.execCmd(String.format("ping -c 1 %s", realIp), false);
     ...
     */
    @RequiresPermission(INTERNET)
    public static void isAvailableByDnsAsync(final Managers.Consumer<Boolean> consumer) {
     ...
     */
    @RequiresPermission(INTERNET)
    public static Managers.Task isAvailableByDnsAsync(final String domain, @NonNull final Managers.Consumer<Boolean> consumer) {
        return ManagerBridge.doAsync(new Managers.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
            public Boolean doInBackground() {
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) Managers.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) Managers.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) Managers.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
     ...
     */
    @RequiresPermission(allOf = {ACCESS_WIFI_STATE, INTERNET})
    public static Managers.Task<Boolean> isWifiAvailableAsync(@NonNull final Managers.Consumer<Boolean> consumer) {
        return ManagerBridge.doAsync(new Managers.Task<Boolean>(consumer) {
            @RequiresPermission(allOf = {ACCESS_WIFI_STATE, INTERNET})
            @Override
            public Boolean doInBackground() {
     ...
     * @return the task
     */
    public static Managers.Task<String> getIPAddressAsync(final boolean useIPv4, @NonNull final Managers.Consumer<String> consumer) {
        return ManagerBridge.doAsync(new Managers.Task<String>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(INTERNET)
    public static Managers.Task<String> getDomainAddressAsync(final String domain, @NonNull final Managers.Consumer<String> consumer) {
        return ManagerBridge.doAsync(new Managers.Task<String>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
            public String doInBackground() {
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) Managers.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
    ...
    public static String getSSID() {
        WifiManager wm = (WifiManager) Managers.getApp().getApplicationContext().getSystemService(WIFI_SERVICE);
        if (wm == null) return "";
    ...
    public static final class NetworkChangedReceiver extends BroadcastReceiver {
        ...
        void registerListener(final OnNetworkStatusChangedListener listener) {
            ...
            ManagerBridge.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 0 && mListeners.size() == 1) {
                        ...
                        Managers.getApp().registerReceiver(NetworkChangedReceiver.getInstance(), intentFilter);
                    }
                }
            });
        }
            ...
            ManagerBridge.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 1 && mListeners.size() == 0) {
                        Managers.getApp().unregisterReceiver(NetworkChangedReceiver.getInstance());
                    }
                }
            });
        }
        ...
        public void onReceive(Context context, Intent intent) {
            if (ConnectivityManager.CONNECTIVITY_ACTION.equals(intent.getAction())) {
                // debouncing
                ManagerBridge.runOnUiThreadDelayed(new Runnable() {
                    @Override
                    public void run() {
                        NetworkType networkType = NetworkManager.getNetworkType();
