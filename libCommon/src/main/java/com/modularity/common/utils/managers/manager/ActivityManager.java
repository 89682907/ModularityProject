...
public final class ActivityManager {
    ...
    public static void addActivityLifecycleCallbacks(final Activity activity,
        ...
        ManagerBridge.addActivityLifecycleCallbacks(activity, callbacks);
    }
    ...
    public static void removeActivityLifecycleCallbacks(final Activity activity) {
        ManagerBridge.removeActivityLifecycleCallbacks(activity);
    }
    ...
    public static void removeActivityLifecycleCallbacks(final Activity activity,
                                                        final Managers.ActivityLifecycleCallbacks callbacks) {
        ManagerBridge.removeActivityLifecycleCallbacks(activity, callbacks);
    }
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = ManagerBridge.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(ManagerBridge.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     @Nullable final Bundle options) {
        startActivity(ManagerBridge.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(ManagerBridge.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     @Nullable final Bundle options) {
        startActivity(ManagerBridge.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent) {
        return startActivity(intent, ManagerBridge.getTopActivityOrApp(), null);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent,
                                        @Nullable final Bundle options) {
        return startActivity(intent, ManagerBridge.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivityForResult(@NonNull final Fragment fragment,
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, null, Managers.getApp().getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startActivityForResult(@NonNull final Bundle extras,
                                              ...
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, extras, Managers.getApp().getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, ManagerBridge.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       @Nullable final Bundle options) {
        startActivities(intents, ManagerBridge.getTopActivityOrApp(), options);
    }
    ...
    public static void startLauncherActivity() {
        startLauncherActivity(Managers.getApp().getPackageName());
    }
    ...
    public static List<Activity> getActivityList() {
        return ManagerBridge.getActivityList();
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(Managers.getApp().getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String pkg) {
        if (ManagerBridge.isSpace(pkg)) return "";
    ...
    public static List<String> getMainActivities() {
        return getMainActivities(Managers.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        return ManagerBridge.getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = ManagerBridge.getActivityList();
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = ManagerBridge.getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(Managers.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(Managers.getApp(), clz));
    }
