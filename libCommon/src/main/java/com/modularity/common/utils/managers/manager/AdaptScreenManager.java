 ...
 * 屏幕适配相关
 */
public final class AdaptScreenManager {
    ...
    public static int pt2Px(final float ptValue) {
        DisplayMetrics metrics = Managers.getApp().getResources().getDisplayMetrics();
    ...
    private static void applyDisplayMetrics(final Resources resources, final float newXdpi) {
        ...
        Managers.getApp().getResources().getDisplayMetrics().xdpi = newXdpi;
