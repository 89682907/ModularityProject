...
public final class FragmentManager {
     ...
     */
    public static void add(@NonNull final androidx.fragment.app.FragmentManager fm,
     ...
     * @param fm The manager of fragment.
     */
    public static void show(@NonNull final androidx.fragment.app.FragmentManager fm) {
     ...
     * @param fm The manager of fragment.
     */
    public static void hide(@NonNull final androidx.fragment.app.FragmentManager fm) {
        List<Fragment> fragments = getFragments(fm);
     ...
     * @param containerId The id of container.
     */
    public static void replace(@NonNull final androidx.fragment.app.FragmentManager fm,
    ...
    public static void replace(@NonNull final Fragment srcFragment,
                               ...
                               final String destTag,
                               final boolean isAddStack) {
        androidx.fragment.app.FragmentManager fm = srcFragment.getFragmentManager();
        if (fm == null) return;
     ...
     * @param fm The manager of fragment.
     */
    public static void pop(@NonNull final androidx.fragment.app.FragmentManager fm) {
        pop(fm, true);
    }
     ...
     */
    public static void popTo(@NonNull final androidx.fragment.app.FragmentManager fm,
    ...
    public static void popTo(@NonNull final androidx.fragment.app.FragmentManager fm,
        ...
        if (isImmediate) {
            fm.popBackStackImmediate(popClz.getName(),
                    isIncludeSelf ? androidx.fragment.app.FragmentManager.POP_BACK_STACK_INCLUSIVE : 0);
        } else {
     ...
     * @param fm The manager of fragment.
     */
    public static void popAll(@NonNull final androidx.fragment.app.FragmentManager fm) {
        popAll(fm, true);
    }
     ...
     * @param fm The manager of fragment.
     */
    public static void popAll(@NonNull final androidx.fragment.app.FragmentManager fm, final boolean isImmediate) {
        if (fm.getBackStackEntryCount() > 0) {
            androidx.fragment.app.FragmentManager.BackStackEntry entry = fm.getBackStackEntryAt(0);
            if (isImmediate) {
                fm.popBackStackImmediate(entry.getId(), androidx.fragment.app.FragmentManager.POP_BACK_STACK_INCLUSIVE);
            } else {
                fm.popBackStack(entry.getId(), androidx.fragment.app.FragmentManager.POP_BACK_STACK_INCLUSIVE);
            }
        }
    }
     ...
     * @param fm The manager of fragment.
     */
    public static void removeAll(@NonNull final androidx.fragment.app.FragmentManager fm) {
        List<Fragment> fragments = getFragments(fm);
        operateNoAnim(fm,
    ...
    private static void operateNoAnim(@Nullable final androidx.fragment.app.FragmentManager fm,
                                      final int type,
                                      final Fragment src,
                                      Fragment... dest) {
        if (fm == null) return;
     ...
     * @return the top fragment
     */
    public static Fragment getTop(@NonNull final androidx.fragment.app.FragmentManager fm) {
     ...
     * @return the top fragment in stack
     */
    public static Fragment getTopInStack(@NonNull final androidx.fragment.app.FragmentManager fm) {
        return getTopIsInStack(fm, null, true);
    }

    private static Fragment getTopIsInStack(@NonNull final androidx.fragment.app.FragmentManager fm,
     ...
     * @return the top fragment which is shown
     */
    public static Fragment getTopShow(@NonNull final androidx.fragment.app.FragmentManager fm) {
     ...
     * @return the top fragment which is shown in stack
     */
    public static Fragment getTopShowInStack(@NonNull final androidx.fragment.app.FragmentManager fm) {
        return getTopShowIsInStack(fm, null, true);
    }

    private static Fragment getTopShowIsInStack(@NonNull final androidx.fragment.app.FragmentManager fm,
                                                Fragment parentFragment,
                                                final boolean isInStack) {
        List<Fragment> fragments = getFragments(fm);
        for (int i = fragments.size() - 1; i >= 0; --i) {
     ...
     * @return the fragments in manager
     */
    public static List<Fragment> getFragments(@NonNull final androidx.fragment.app.FragmentManager fm) {
     ...
     * @return the fragments in stack in manager
     */
    public static List<Fragment> getFragmentsInStack(@NonNull final androidx.fragment.app.FragmentManager fm) {
        List<Fragment> fragments = getFragments(fm);
     ...
     * @return all fragments in manager
     */
    public static List<FragmentNode> getAllFragments(@NonNull final androidx.fragment.app.FragmentManager fm) {
        return getAllFragments(fm, new ArrayList<FragmentNode>());
    }

    private static List<FragmentNode> getAllFragments(@NonNull final androidx.fragment.app.FragmentManager fm,
     ...
     * @return all fragments in stack in manager
     */
    public static List<FragmentNode> getAllFragmentsInStack(@NonNull final androidx.fragment.app.FragmentManager fm) {
        return getAllFragmentsInStack(fm, new ArrayList<FragmentNode>());
    }

    private static List<FragmentNode> getAllFragmentsInStack(@NonNull final androidx.fragment.app.FragmentManager fm,
                                                             final List<FragmentNode> result) {
        List<Fragment> fragments = getFragments(fm);
        for (int i = fragments.size() - 1; i >= 0; --i) {
            Fragment fragment = fragments.get(i);
     ...
     */
    public static Fragment findFragment(@NonNull final androidx.fragment.app.FragmentManager fm,
     ...
     * @return {@code true}: the fragment consumes the back press<br>{@code false}: otherwise
     */
    public static boolean dispatchBackPress(@NonNull final androidx.fragment.app.FragmentManager fm) {
        List<Fragment> fragments = getFragments(fm);
