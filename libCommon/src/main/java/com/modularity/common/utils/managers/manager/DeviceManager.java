...
public final class DeviceManager {
    ...
    public static boolean isAdbEnabled() {
        return Settings.Secure.getInt(
                Managers.getApp().getContentResolver(),
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            final WifiManager wifi = (WifiManager) Managers.getApp()
    ...
    private static String getMacAddressByFile() {
        ShellManager.CommandResult result = ManagerBridge.execCmd("getprop wifi.interface", false);
        if (result.result == 0) {
            String name = result.successMsg;
            if (name != null) {
                result = ManagerBridge.execCmd("cat /sys/class/net/" + name + "/address", false);
                if (result.result == 0) {
    ...
    public static boolean isEmulator() {
        ...
        String operatorName = "";
        TelephonyManager tm = (TelephonyManager) Managers.getApp().getSystemService(Context.TELEPHONY_SERVICE);
        if (tm != null) {
        ...
        boolean checkDial = intent.resolveActivity(Managers.getApp().getPackageManager()) == null;
...
//        if (checkDebuggerConnected) return true;
    ...
    public static String getUniqueDeviceId(String prefix, boolean useCache) {
        ...
        if (udid == null) {
            synchronized (DeviceManager.class) {
                if (udid == null) {
                    final String id = ManagerBridge.getSpUtils4Utils().getString(KEY_UDID, null);
                    if (id != null) {
                        udid = id;
                        return udid;
                    }
    ...
    public static boolean isSameDevice(final String uniqueDeviceId) {
        ...
        final String cachedId = ManagerBridge.getSpUtils4Utils().getString(KEY_UDID, null);
    ...
    private static String saveUdid(String prefix, String id) {
        ...
        ManagerBridge.getSpUtils4Utils().put(KEY_UDID, udid);
        return udid;
    }
