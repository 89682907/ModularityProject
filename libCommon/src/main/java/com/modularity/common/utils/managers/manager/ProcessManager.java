...
public final class ProcessManager {
    ...
    public static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) Managers.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(Managers.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) Managers.getApp().getSystemService(Context.APP_OPS_SERVICE);
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) Managers.getApp()
    ...
    public static boolean isMainProcess() {
        return Managers.getApp().getPackageName().equals(getCurrentProcessName());
    }
    ...
    private static String getCurrentProcessNameByReflect() {
        String processName = "";
        try {
            Application app = Managers.getApp();
