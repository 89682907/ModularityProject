...
import com.modularity.common.utils.managers.constant.CacheConstants;
...
public final class CacheDiskManager implements CacheConstants {
    ...
    private static final Map<String, CacheDiskManager> CACHE_MAP = new HashMap<>();
    ...
    /**
     * Return the single {@link CacheDiskManager} instance.
     ...
     * @return the single {@link CacheDiskManager} instance
     */
    public static CacheDiskManager getInstance() {
     ...
     * @return the single {@link CacheDiskManager} instance
     */
    public static CacheDiskManager getInstance(final String cacheName) {
     ...
     * @return the single {@link CacheDiskManager} instance
     */
    public static CacheDiskManager getInstance(final long maxSize, final int maxCount) {
     ...
     * @return the single {@link CacheDiskManager} instance
     */
    public static CacheDiskManager getInstance(String cacheName, final long maxSize, final int maxCount) {
        if (ManagerBridge.isSpace(cacheName)) cacheName = "cacheUtils";
        File file = new File(Managers.getApp().getCacheDir(), cacheName);
     ...
     * @return the single {@link CacheDiskManager} instance
     */
    public static CacheDiskManager getInstance(@NonNull final File cacheDir) {
    ...
    public static CacheDiskManager getInstance(@NonNull final File cacheDir,
        ...
        CacheDiskManager cache = CACHE_MAP.get(cacheKey);
        if (cache == null) {
            synchronized (CacheDiskManager.class) {
                cache = CACHE_MAP.get(cacheKey);
                if (cache == null) {
                    cache = new CacheDiskManager(cacheKey, cacheDir, maxSize, maxCount);
    ...
    private CacheDiskManager(final String cacheKey,
                             final File cacheDir,
                             final long maxSize,
                             final int maxCount) {
        mCacheKey = cacheKey;
    ...
    private void realPutBytes(final String key, byte[] value, int saveTime) {
        ...
        ManagerBridge.writeFileFromBytes(file, value);
    ...
    private byte[] realGetBytes(@NonNull final String key, final byte[] defaultValue) {
        ...
        byte[] data = ManagerBridge.readFile2Bytes(file);
    ...
    public void put(@NonNull final String key, final String value, final int saveTime) {
        realPutBytes(TYPE_STRING + key, ManagerBridge.string2Bytes(value), saveTime);
    }
    ...
    public String getString(@NonNull final String key, final String defaultValue) {
        ...
        return ManagerBridge.bytes2String(bytes);
    }
    ...
    public void put(@NonNull final String key,
                    ...
                    final int saveTime) {
        realPutBytes(TYPE_JSON_OBJECT + key, ManagerBridge.jsonObject2Bytes(value), saveTime);
    }
    ...
    public JSONObject getJSONObject(@NonNull final String key, final JSONObject defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return ManagerBridge.bytes2JSONObject(bytes);
    }
    ...
    public void put(@NonNull final String key, final JSONArray value, final int saveTime) {
        realPutBytes(TYPE_JSON_ARRAY + key, ManagerBridge.jsonArray2Bytes(value), saveTime);
    }
    ...
    public JSONArray getJSONArray(@NonNull final String key, final JSONArray defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return ManagerBridge.bytes2JSONArray(bytes);
    }
    ...
    public void put(@NonNull final String key, final Bitmap value, final int saveTime) {
        realPutBytes(TYPE_BITMAP + key, ManagerBridge.bitmap2Bytes(value), saveTime);
    }
    ...
    public Bitmap getBitmap(@NonNull final String key, final Bitmap defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return ManagerBridge.bytes2Bitmap(bytes);
    }
    ...
    public void put(@NonNull final String key, final Drawable value, final int saveTime) {
        realPutBytes(TYPE_DRAWABLE + key, ManagerBridge.drawable2Bytes(value), saveTime);
    }
    ...
    public Drawable getDrawable(@NonNull final String key, final Drawable defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return ManagerBridge.bytes2Drawable(bytes);
    }
    ...
    public void put(@NonNull final String key, final Parcelable value, final int saveTime) {
        realPutBytes(TYPE_PARCELABLE + key, ManagerBridge.parcelable2Bytes(value), saveTime);
    }
    ...
    public <T> T getParcelable(@NonNull final String key,
        ...
        if (bytes == null) return defaultValue;
        return ManagerBridge.bytes2Parcelable(bytes, creator);
    }
    ...
    public void put(@NonNull final String key, final Serializable value, final int saveTime) {
        realPutBytes(TYPE_SERIALIZABLE + key, ManagerBridge.serializable2Bytes(value), saveTime);
    }
    ...
    public Object getSerializable(@NonNull final String key, final Object defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return ManagerBridge.bytes2Object(bytes);
    }
