...
public final class SnackbarManager {
    ...
    private SnackbarManager(final View parent) {
        setDefault();
        this.view = parent;
    }
     ...
     * @return the single {@link SnackbarManager} instance
     */
    public static SnackbarManager with(@NonNull final View view) {
        return new SnackbarManager(view);
    }
     ...
     * @return the single {@link SnackbarManager} instance
     */
    public SnackbarManager setMessage(@NonNull final CharSequence msg) {
        this.message = msg;
        return this;
    }
     ...
     * @return the single {@link SnackbarManager} instance
     */
    public SnackbarManager setMessageColor(@ColorInt final int color) {
     ...
     * @return the single {@link SnackbarManager} instance
     */
    public SnackbarManager setBgColor(@ColorInt final int color) {
        this.bgColor = color;
        return this;
    }
     ...
     * @return the single {@link SnackbarManager} instance
     */
    public SnackbarManager setBgResource(@DrawableRes final int bgResource) {
     ...
     * @return the single {@link SnackbarManager} instance
     */
    public SnackbarManager setDuration(@Duration final int duration) {
     ...
     * @return the single {@link SnackbarManager} instance
     */
    public SnackbarManager setAction(@NonNull final CharSequence text,
     ...
     */
    public SnackbarManager setBottomMargin(@IntRange(from = 1) final int bottomMargin) {
