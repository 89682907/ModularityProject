...
import com.modularity.common.utils.managers.constant.MemoryConstants;
import com.modularity.common.utils.managers.constant.TimeConstants;
...
public final class ConvertManager {
    ...
    public static byte[] hexString2Bytes(String hexString) {
        if (ManagerBridge.isSpace(hexString)) return new byte[0];
    ...
    public static byte[] bitmap2Bytes(final Bitmap bitmap) {
        return ManagerBridge.bitmap2Bytes(bitmap);
    }
    ...
    public static byte[] bitmap2Bytes(final Bitmap bitmap, final Bitmap.CompressFormat format, int quality) {
        return ManagerBridge.bitmap2Bytes(bitmap, format, quality);
    }
    ...
    public static byte[] drawable2Bytes(final Drawable drawable) {
        return ManagerBridge.drawable2Bytes(drawable);
    }
    ...
    public static byte[] drawable2Bytes(final Drawable drawable, final Bitmap.CompressFormat format, int quality) {
        return ManagerBridge.drawable2Bytes(drawable, format, quality);
    }
    ...
    public static String millis2FitTimeSpan(long millis, int precision) {
        return ManagerBridge.millis2FitTimeSpan(millis, precision);
    }
    ...
    public static Bitmap drawable2Bitmap(final Drawable drawable) {
        return ManagerBridge.drawable2Bitmap(drawable);
    }
    ...
    public static Drawable bitmap2Drawable(final Bitmap bitmap) {
        return ManagerBridge.bitmap2Drawable(bitmap);
    }
    ...
    public static Bitmap view2Bitmap(final View view) {
        return ManagerBridge.view2Bitmap(view);
    }
    ...
    public static int dp2px(final float dpValue) {
        return ManagerBridge.dp2px(dpValue);
    }
    ...
    public static int px2dp(final float pxValue) {
        return ManagerBridge.px2dp(pxValue);
    }
    ...
    public static int sp2px(final float spValue) {
        return ManagerBridge.sp2px(spValue);
    }
    ...
    public static int px2sp(final float pxValue) {
        return ManagerBridge.px2sp(pxValue);
    }

    private static String getSafeCharset(String charsetName) {
        String cn = charsetName;
        if (ManagerBridge.isSpace(charsetName) || !Charset.isSupported(charsetName)) {
            cn = "UTF-8";
        }
        return cn;
    }
