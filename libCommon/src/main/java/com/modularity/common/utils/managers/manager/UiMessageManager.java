...
public final class UiMessageManager implements Handler.Callback {

    private static final String  TAG   = "UiMessageUtils";
    private static final boolean DEBUG = ManagerBridge.isAppDebug();
    ...
    private static final class LazyHolder {
        private static final UiMessageManager INSTANCE = new UiMessageManager();
    }
}
