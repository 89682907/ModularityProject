...
public final class ShellManager {
     ...
     * @return the task
     */
    public static Managers.Task<CommandResult> execCmdAsync(final String command,
                                                            final boolean isRooted,
                                                            final Managers.Consumer<CommandResult> consumer) {
     ...
     * @return the task
     */
    public static Managers.Task<CommandResult> execCmdAsync(final List<String> commands,
                                                            final boolean isRooted,
                                                            final Managers.Consumer<CommandResult> consumer) {
     ...
     * @return the task
     */
    public static Managers.Task<CommandResult> execCmdAsync(final String[] commands,
                                                            final boolean isRooted,
                                                            final Managers.Consumer<CommandResult> consumer) {
    ...
    public static Managers.Task<CommandResult> execCmdAsync(final String[] commands,
                                                            final boolean isRooted,
                                                            final boolean isNeedResultMsg,
                                                            @NonNull final Managers.Consumer<CommandResult> consumer) {
        return ManagerBridge.doAsync(new Managers.Task<CommandResult>(consumer) {
            @Override
