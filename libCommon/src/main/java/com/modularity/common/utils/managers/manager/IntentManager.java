...
public final class IntentManager {
    ...
    public static Intent getInstallAppIntent(final String filePath) {
        return getInstallAppIntent(ManagerBridge.getFileByPath(filePath));
    }
    ...
    public static Intent getLaunchAppIntent(final String pkgName) {
        String launcherActivity = ManagerBridge.getLauncherActivity(pkgName);
        if (ManagerBridge.isSpace(launcherActivity)) return null;
    ...
    public static Intent getShareTextImageIntent(@Nullable final String content, final String imagePath) {
        return getShareTextImageIntent(content, ManagerBridge.getFileByPath(imagePath));
    }
    ...
    public static Intent getShareTextImageIntent(@Nullable final String content, final File imageFile) {
        return getShareTextImageIntent(content, ManagerBridge.file2Uri(imageFile));
    }
    ...
    public static Intent getShareTextImageIntent(@Nullable final String content,
        ...
        if (imagePaths != null) {
            for (String imagePath : imagePaths) {
                File file = ManagerBridge.getFileByPath(imagePath);
                if (file != null) {
                    files.add(file);
                }
            }
    ...
    public static Intent getShareTextImageIntent(@Nullable final String content, final List<File> images) {
        ...
        if (images != null) {
            for (File image : images) {
                Uri uri = ManagerBridge.file2Uri(image);
                if (uri != null) {
                    uris.add(uri);
                }
            }
