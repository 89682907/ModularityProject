...
public final class ZipManager {
    ...
    public static boolean zipFiles(final Collection<String> srcFilePaths,
        ...
        try {
            ...
            for (String srcFile : srcFilePaths) {
                if (!zipFile(ManagerBridge.getFileByPath(srcFile), "", zos, comment)) return false;
            }
            return true;
        } finally {
            if (zos != null) {
    ...
    public static boolean zipFile(final String srcFilePath,
                                  final String zipFilePath)
            throws IOException {
        return zipFile(ManagerBridge.getFileByPath(srcFilePath), ManagerBridge.getFileByPath(zipFilePath), null);
    }
    ...
    public static boolean zipFile(final String srcFilePath,
                                  ...
                                  final String comment)
            throws IOException {
        return zipFile(ManagerBridge.getFileByPath(srcFilePath), ManagerBridge.getFileByPath(zipFilePath), comment);
    }
    ...
    private static boolean zipFile(final File srcFile,
                                   ...
                                   final String comment)
            throws IOException {
        rootPath = rootPath + (ManagerBridge.isSpace(rootPath) ? "" : File.separator) + srcFile.getName();
    ...
    public static List<File> unzipFileByKeyword(final String zipFilePath,
            ...
            throws IOException {
        return unzipFileByKeyword(ManagerBridge.getFileByPath(zipFilePath), ManagerBridge.getFileByPath(destDirPath), keyword);
    }
    ...
    public static List<File> unzipFileByKeyword(final File zipFile,
        ...
        try {
            if (ManagerBridge.isSpace(keyword)) {
    ...
    private static boolean unzipChildFile(final File destDir,
        ...
        if (entry.isDirectory()) {
            return ManagerBridge.createOrExistsDir(file);
        } else {
            if (!ManagerBridge.createOrExistsFile(file)) return false;
            InputStream in = null;
    ...
    public static List<String> getFilesPath(final String zipFilePath)
            throws IOException {
        return getFilesPath(ManagerBridge.getFileByPath(zipFilePath));
    }
    ...
    public static List<String> getComments(final String zipFilePath)
            throws IOException {
        return getComments(ManagerBridge.getFileByPath(zipFilePath));
    }
