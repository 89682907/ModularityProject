...
public final class SpanManager {
    ...
    public static SpanManager with(final TextView textView) {
        return new SpanManager(textView);
    }
    ...
    private SpanManager(TextView textView) {
        this();
        mTextView = textView;
    }
     ...
     *             </ul>
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setBullet(@ColorInt final int color,
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setFontProportion(final float proportion) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setFontXProportion(final float proportion) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setStrikethrough() {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setUnderline() {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setSuperscript() {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setSubscript() {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setHorizontalAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setVerticalAlign(@Align final int align) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setClickSpan(@ColorInt final int color,
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setUrl(@NonNull final String url) {
        if (mTextView != null && mTextView.getMovementMethod() == null) {
            mTextView.setMovementMethod(LinkMovementMethod.getInstance());
        }
        this.url = url;
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final Blur style) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                 final float dx,
                                 final float dy,
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link SpanManager} instance
     */
    public SpanManager appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
...
//            LogUtils.e(fm, sfm);
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(Managers.getApp().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            Managers.getApp().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(Managers.getApp().getResources(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(Managers.getApp(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
