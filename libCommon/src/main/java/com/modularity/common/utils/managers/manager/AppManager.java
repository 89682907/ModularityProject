...
public final class AppManager {
     ...
     */
    public static void registerAppStatusChangedListener(@NonNull final Managers.OnAppStatusChangedListener listener) {
        ManagerBridge.addOnAppStatusChangedListener(listener);
    }
     ...
     * @param listener The status of application changed listener
     */
    public static void unregisterAppStatusChangedListener(@NonNull final Managers.OnAppStatusChangedListener listener) {
        ManagerBridge.removeOnAppStatusChangedListener(listener);
    }
    ...
    public static void installApp(final String filePath) {
        installApp(ManagerBridge.getFileByPath(filePath));
    }
    ...
    public static void installApp(final File file) {
        Intent installAppIntent = ManagerBridge.getInstallAppIntent(file);
        if (installAppIntent == null) return;
        Managers.getApp().startActivity(installAppIntent);
    }
    ...
    public static void installApp(final Uri uri) {
        Intent installAppIntent = ManagerBridge.getInstallAppIntent(uri);
        if (installAppIntent == null) return;
        Managers.getApp().startActivity(installAppIntent);
    }
    ...
    public static void uninstallApp(final String packageName) {
        if (ManagerBridge.isSpace(packageName)) return;
        Managers.getApp().startActivity(ManagerBridge.getUninstallAppIntent(packageName));
    }
    ...
    public static boolean isAppInstalled(final String pkgName) {
        if (ManagerBridge.isSpace(pkgName)) return false;
        PackageManager pm = Managers.getApp().getPackageManager();
        try {
    ...
    public static boolean isAppRoot() {
        ShellManager.CommandResult result = ManagerBridge.execCmd("echo root", true);
    ...
    public static boolean isAppDebug() {
        return isAppDebug(Managers.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug(final String packageName) {
        if (ManagerBridge.isSpace(packageName)) return false;
        ApplicationInfo ai = Managers.getApp().getApplicationInfo();
    ...
    public static boolean isAppSystem() {
        return isAppSystem(Managers.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager am = (ActivityManager) Managers.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        if (am == null) return false;
        List<ActivityManager.RunningAppProcessInfo> info = am.getRunningAppProcesses();
        if (info == null || info.size() == 0) return false;
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                if (aInfo.processName.equals(Managers.getApp().getPackageName())) {
                    return true;
                }
            }
        }
    ...
    public static boolean isAppForeground(@NonNull final String pkgName) {
        return !ManagerBridge.isSpace(pkgName) && pkgName.equals(ManagerBridge.getForegroundProcessName());
    }
    ...
    public static void launchApp(final String packageName) {
        if (ManagerBridge.isSpace(packageName)) return;
        Intent launchAppIntent = ManagerBridge.getLaunchAppIntent(packageName);
        if (launchAppIntent == null) {
            Log.e("AppUtils", "Didn't exist launcher activity.");
            return;
        }
        Managers.getApp().startActivity(launchAppIntent);
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        Intent intent = ManagerBridge.getLaunchAppIntent(Managers.getApp().getPackageName());
        if (intent == null) {
            Log.e("AppUtils", "Didn't exist launcher activity.");
            return;
        }
        ...
        Managers.getApp().startActivity(intent);
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(Managers.getApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String pkgName) {
        if (ManagerBridge.isSpace(pkgName)) return;
        Intent intent = ManagerBridge.getLaunchAppDetailsSettingsIntent(pkgName, true);
        if (!ManagerBridge.isIntentAvailable(intent)) return;
        Managers.getApp().startActivity(intent);
    }
    ...
    public static void launchAppDetailsSettings(final Activity activity, final int requestCode) {
        launchAppDetailsSettings(activity, requestCode, Managers.getApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final Activity activity, final int requestCode, final String pkgName) {
        if (activity == null || ManagerBridge.isSpace(pkgName)) return;
        Intent intent = ManagerBridge.getLaunchAppDetailsSettingsIntent(pkgName, false);
        if (!ManagerBridge.isIntentAvailable(intent)) return;
    ...
    public static void exitApp() {
        ManagerBridge.finishAllActivities();
        System.exit(0);
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(Managers.getApp().getPackageName());
    }
    ...
    public static Drawable getAppIcon(final String packageName) {
        if (ManagerBridge.isSpace(packageName)) return null;
        try {
            PackageManager pm = Managers.getApp().getPackageManager();
    ...
    public static int getAppIconId() {
        return getAppIconId(Managers.getApp().getPackageName());
    }
    ...
    public static int getAppIconId(final String packageName) {
        if (ManagerBridge.isSpace(packageName)) return 0;
        try {
            PackageManager pm = Managers.getApp().getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
    ...
    public static String getAppPackageName() {
        return Managers.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(Managers.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(Managers.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(Managers.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(Managers.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode(final String packageName) {
        if (ManagerBridge.isSpace(packageName)) return -1;
        try {
            PackageManager pm = Managers.getApp().getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(Managers.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(Managers.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(Managers.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(Managers.getApp().getPackageName());
    }
    ...
    public static int getAppUid() {
        return getAppUid(Managers.getApp().getPackageName());
    }
    ...
    public static int getAppUid(String pkgName) {
        try {
            return Managers.getApp().getPackageManager().getApplicationInfo(pkgName, 0).uid;
        } catch (Exception e) {
            e.printStackTrace();
        }
        return -1;
    ...
    private static String getAppSignatureHash(final String packageName, final String algorithm) {
        ...
        return ManagerBridge.bytes2HexString(ManagerBridge.hashTemplate(signature[0].toByteArray(), algorithm))
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(Managers.getApp().getPackageName());
    }
    ...
    public static AppInfo getApkInfo(final String apkFilePath) {
        if (ManagerBridge.isSpace(apkFilePath)) return null;
        PackageManager pm = Managers.getApp().getPackageManager();
        if (pm == null) return null;
