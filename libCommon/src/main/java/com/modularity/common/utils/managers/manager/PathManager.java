...
public final class PathManager {
    ...
    public static String getInternalAppDataPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            return Managers.getApp().getApplicationInfo().dataDir;
        }
        return getAbsolutePath(Managers.getApp().getDataDir());
    }
    ...
    public static String getInternalAppCodeCacheDir() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return Managers.getApp().getApplicationInfo().dataDir + "/code_cache";
        }
        return getAbsolutePath(Managers.getApp().getCodeCacheDir());
    }
    ...
    public static String getInternalAppCachePath() {
        return getAbsolutePath(Managers.getApp().getCacheDir());
    }
    ...
    public static String getInternalAppDbsPath() {
        return Managers.getApp().getApplicationInfo().dataDir + "/databases";
    }
    ...
    public static String getInternalAppDbPath(String name) {
        return getAbsolutePath(Managers.getApp().getDatabasePath(name));
    }
    ...
    public static String getInternalAppFilesPath() {
        return getAbsolutePath(Managers.getApp().getFilesDir());
    }
    ...
    public static String getInternalAppSpPath() {
        return Managers.getApp().getApplicationInfo().dataDir + "/shared_prefs";
    }
    ...
    public static String getInternalAppNoBackupFilesPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return Managers.getApp().getApplicationInfo().dataDir + "/no_backup";
        }
        return getAbsolutePath(Managers.getApp().getNoBackupFilesDir());
    }
    ...
    public static String getExternalStoragePath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
    ...
    public static String getExternalAppDataPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        File externalCacheDir = Managers.getApp().getExternalCacheDir();
    ...
    public static String getExternalAppCachePath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Managers.getApp().getExternalCacheDir());
    }
    ...
    public static String getExternalAppFilesPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Managers.getApp().getExternalFilesDir(null));
    }
    ...
    public static String getExternalAppMusicPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Managers.getApp().getExternalFilesDir(Environment.DIRECTORY_MUSIC));
    }
    ...
    public static String getExternalAppPodcastsPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Managers.getApp().getExternalFilesDir(Environment.DIRECTORY_PODCASTS));
    }
    ...
    public static String getExternalAppRingtonesPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Managers.getApp().getExternalFilesDir(Environment.DIRECTORY_RINGTONES));
    }
    ...
    public static String getExternalAppAlarmsPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Managers.getApp().getExternalFilesDir(Environment.DIRECTORY_ALARMS));
    }
    ...
    public static String getExternalAppNotificationsPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Managers.getApp().getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS));
    }
    ...
    public static String getExternalAppPicturesPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Managers.getApp().getExternalFilesDir(Environment.DIRECTORY_PICTURES));
    }
    ...
    public static String getExternalAppMoviesPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Managers.getApp().getExternalFilesDir(Environment.DIRECTORY_MOVIES));
    }
    ...
    public static String getExternalAppDownloadPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Managers.getApp().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS));
    }
    ...
    public static String getExternalAppDcimPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Managers.getApp().getExternalFilesDir(Environment.DIRECTORY_DCIM));
    }
    ...
    public static String getExternalAppDocumentsPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return getAbsolutePath(Managers.getApp().getExternalFilesDir(null)) + "/Documents";
        }
        return getAbsolutePath(Managers.getApp().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS));
    }
    ...
    public static String getExternalAppObbPath() {
        if (!ManagerBridge.isSDCardEnableByEnvironment()) return "";
        return getAbsolutePath(Managers.getApp().getObbDir());
    }
