...
public final class PhoneManager {
    ...
    public static void dial(final String phoneNumber) {
        Managers.getApp().startActivity(ManagerBridge.getDialIntent(phoneNumber));
    }
    ...
    public static void call(final String phoneNumber) {
        Managers.getApp().startActivity(ManagerBridge.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(final String phoneNumber, final String content) {
        Managers.getApp().startActivity(ManagerBridge.getSendSmsIntent(phoneNumber, content));
    }

    private static TelephonyManager getTelephonyManager() {
        return (TelephonyManager) Managers.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    }
}
