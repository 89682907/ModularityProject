...
package com.modularity.common.expand.swipeRefresh;
...
public class ExpandSwipeRefreshLayout extends ViewGroup {
    ...
    public ExpandSwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.ExpandSwipeRefreshLayout);
        SwipeRefreshLayoutDirection direction = SwipeRefreshLayoutDirection.getFromInt(a2.getInt(R.styleable.ExpandSwipeRefreshLayout_direction, 0));
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mTarget.measure(MeasureSpec.makeMeasureSpec(getMeasuredWidth() - getPaddingLeft() - getPaddingRight(), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(
