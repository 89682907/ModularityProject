...
public class JLoopViewPager extends RecyclerView {
    ...
    public JLoopViewPager(Context context) {
        super(context);
    }

    public JLoopViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public JLoopViewPager(Context context, AttributeSet attrs, int defStyle) {
