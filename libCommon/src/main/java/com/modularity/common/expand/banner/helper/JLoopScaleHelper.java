...
public class JLoopScaleHelper {
    private JLoopViewPager mRecyclerView;
    ...
    public void attachToRecyclerView(final JLoopViewPager mRecyclerView) {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                //这里变换位置实现循环
                JPageAdapter adapter = (JPageAdapter) mRecyclerView.getAdapter();
