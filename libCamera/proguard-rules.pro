...
-keepclassmembers class * {
    @com.modularity.x.camera.annotation.KeepNotProguard <methods>;
}

-keep @com.modularity.x.camera.annotation.KeepNotProguard class * {*;}
-keep class * {
    @com.modularity.x.camera.annotation.KeepNotProguard <fields>;
}
-keepclassmembers class * {
    @com.modularity.x.camera.annotation.KeepNotProguard <methods>;
}
