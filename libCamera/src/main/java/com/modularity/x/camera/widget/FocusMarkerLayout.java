package com.modularity.x.camera.widget;
...
import com.modularity.x.camera.CameraView;
import com.modularity.x.camera.listener.OnMoveListener;
import com.modularity.x.camera.util.XUtils;
        ...
        if (event.getPointerCount() > 1) {
            ...
            if (fingerSpacing != 0) {
                try {
                    ...
                    LogManager.iTag(TAG, "onTouch error : " + e);
                }
            }
