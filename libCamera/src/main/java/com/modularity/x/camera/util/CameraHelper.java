...
public final class CameraHelper {
    ...
    public static Size getSizeWithClosestRatio(List<Size> sizes, @NonNull Size expectSize) {
        ...
        LogManager.iTag(TAG, "getSizeWithClosestRatio : expected " + expectSize + ", result " + optimalSize);
        return optimalSize;
    }
    ...
    public static Size getSizeWithClosestRatioSizeAndQuality(List<Size> sizes,
        ...
        if (expectSize != null && aspectRatio.ratio() != expectSize.ratio()) {
            LogManager.iTag(TAG, "The expected ratio differs from ratio of expected size.");
        }
        ...
        LogManager.iTag(TAG, "sorted sizes : " + sameSizes);
