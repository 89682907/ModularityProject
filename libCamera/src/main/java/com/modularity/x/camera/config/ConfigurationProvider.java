package com.modularity.x.camera.config;
...
public final class ConfigurationProvider {
    ...
    public List<Size> getSizes(android.hardware.Camera camera,
        ...
        LogManager.iTag(TAG, "getSizes hash : " + Integer.toHexString(hash));
    ...
    public List<Float> getZoomRatios(android.hardware.Camera camera,
        ...
        LogManager.iTag(TAG, "getZoomRatios hash : " + Integer.toHexString(hash));
